    ...
    describe('JwtTokenService', () => {
        ...
        describe('signAccessToken', () => {
            ...
            it('should include user claims in access token', () => {
                ...
                const callArgs = (jwtServiceMock.sign as jest.Mock).mock
                    .calls[0];
            ...
            it('should throw if JWT_ISSUER not configured', () => {
                ...
                expect(() =>
                    service.signAccessToken(accessTokenClaims),
                ).toThrow('Falta la variable de entorno JWT_ISSUER');
            });
            ...
            it('should throw if JWT_AUDIENCE not configured', () => {
                ...
                expect(() =>
                    service.signAccessToken(accessTokenClaims),
                ).toThrow('Falta la variable de entorno JWT_AUDIENCE');
            });
            ...
            it('should throw if JWT_EXPIRES_IN not configured', () => {
                ...
                expect(() =>
                    service.signAccessToken(accessTokenClaims),
                ).toThrow('Falta la variable de entorno JWT_EXPIRES_IN');
            });
        ...
        describe('token lifecycle', () => {
            ...
            it('should use different secrets for access and refresh tokens', () => {
                ...
                service.signRefreshToken(refreshTokenClaims);
                const refreshCallSecret = (jwtServiceMock.sign as jest.Mock)
                    .mock.calls[0][1].secret;
