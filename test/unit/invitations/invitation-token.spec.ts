	...
	describe('InvitationToken entity', () => {
		...
		describe('accept', () => {
			it('should accept pending invitation and set consumed_at', () => {
				...
				expect(invitation.consumed_at!.getTime()).toBeGreaterThanOrEqual(
					beforeAccept.getTime(),
				);
			});
			...
			it('should reject accept on expired invitation by date', () => {
				...
				expect(() => invitation.accept()).toThrow(InvitationExpiredException);
			});
		...
		describe('revoke', () => {
			...
			it('should reject revoke on expired invitation by date', () => {
				...
				expect(() => invitation.revoke()).toThrow(InvitationExpiredException);
			});
		...
		describe('expire', () => {
			...
			it('should reject expire on already expired invitation', () => {
				...
				expect(() => invitation.expire()).toThrow(InvitationExpiredException);
			});
