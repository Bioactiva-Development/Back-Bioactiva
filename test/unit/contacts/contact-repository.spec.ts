    ...
    describe('PrismaContactRepository', () => {
        ...
        describe('save', () => {
            it('should create new contact when ID is 0', async () => {
                ...
                (mockPrisma.contacto!.create as jest.Mock).mockResolvedValue(
                    mockContactData,
                );
            ...
            it('should update existing contact when ID is provided', async () => {
                ...
                (mockPrisma.contacto!.update as jest.Mock).mockResolvedValue(
                    mockContactData,
                );
        ...
        describe('findById', () => {
            it('should return contact when found', async () => {
                (
                    mockPrisma.contacto!.findUnique as jest.Mock
        ...
        describe('findByEmail', () => {
            it('should return contact when email found', async () => {
                (mockPrisma.contacto!.findFirst as jest.Mock).mockResolvedValue(
                    mockContactData,
                );
        ...
        describe('findByOrganizationId', () => {
            it('should return contacts for organization', async () => {
                const contacts = [
                    mockContactData,
                    { ...mockContactData, id: 2, nombres: 'Juan' },
                ];
            ...
            it('should return empty array when no contacts found', async () => {
                ...
                const result =
                    await repository.findByOrganizationId('org-nonexistent');
        ...
        describe('findBySecondaryEmail', () => {
            it('should return contact when secondary email found', async () => {
                ...
                const result =
                    await repository.findBySecondaryEmail('ana.p@personal.com');
            ...
            it('should return null when secondary email not found', async () => {
                ...
                const result =
                    await repository.findBySecondaryEmail('unknown@test.com');
        ...
        describe('findByOrganizationIdWithOrganization', () => {
            it('should return contacts with organization names', async () => {
                ...
                const result =
                    await repository.findByOrganizationIdWithOrganization(
                        'org-1',
                    );
