	...
	describe('OrganizationMapper', () => {
		...
		describe('toDomain - Full conversion', () => {
			it('should convert complete Prisma model to domain entity', () => {
				const result = OrganizationMapper.toDomain(mockOrgData as any);
			...
			it('should preserve all fields', () => {
				...
				expect(result.linkedin).toBe('https://linkedin.com/company/techcorp');
		...
		describe('bidirectional conversion', () => {
			it('should preserve enterprise type through round-trip', () => {
				...
				const toPersistence = OrganizationMapper.toPersistence(original);
