...
import { PASSWORD_RESET_EXPIRATION_SCHEDULER_PORT } from '@/modules/reset_password/domain/ports/password-reset-expiration-scheduler.port';
...
@Module({
    ...
    providers: [
        ...
        {
            provide: PASSWORD_RESET_EXPIRATION_SCHEDULER_PORT,
            useExisting: PasswordResetExpirationPublisher,
        },
        {
