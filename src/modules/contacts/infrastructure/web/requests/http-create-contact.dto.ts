...
export class HttpCreateContactDto {
    ...
    @ApiProperty({ example: 'juan.perez@empresa.com', description: 'Correo principal (único)' })
    @IsEmail()
    @IsNotEmpty()
    @Length(1, 254)
    correo!: string;
    ...
    @ApiProperty({ example: '123e4567-e89b-12d3-a456-426614174000', description: 'UUID de la organización' })
    @IsString()
    @IsNotEmpty()
